...
public class RESTTransferService {
    ...
    public Response transfer(@QueryParam("externalId") Long externalId, @QueryParam("from") Long fromId, @QueryParam("to") Long toId, @QueryParam("amount") BigDecimal amount) {
        ...
        if (externalId == null) externalId = ThreadLocalRandom.current().nextLong(Long.MAX_VALUE);
